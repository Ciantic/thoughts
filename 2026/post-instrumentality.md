...
I was reading [Deep Utopia](https://nickbostrom.com/deep-utopia/) by Nick Bostrom while back, I found him circling on the subject of "post-instrumentality". Concept is simple, while the term looks foreign to those uninitiated. Practically it means a time when all tasks we set to do, can be done better by something else, wheter it is AI or other superhuman beings. Not just some tasks, but all tasks, he gives a lot of examples from work to parenting, in this kind of world one can loose the purpose of doing things.
...
One can argue this has often times been true for many people. If you set out to do some job or hobby, there is usually someone who does it better. But is there something unique when your job is replaced by machines you can't compete with? 

I find that US commentators are fond of "retaining jobs", instead of imaging a future without jobs. Bill Gates, Zuckerberg, ... get the quotes...

Bill Gates recently presented his half-baked solution of "human reserved" jobs in his post [the turbulent AI era is here. The choices we make now are critical.
